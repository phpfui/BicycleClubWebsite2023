...
* [Cobain Reflector](https://www.cobiansoft.com/) Windows backup software to backup the site. Free.
...
Look for equivalent programs for OSX or Linux dev enviornments.
