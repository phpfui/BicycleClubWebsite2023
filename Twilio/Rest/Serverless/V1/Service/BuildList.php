...
class BuildList extends ListResource
	...
	public function create(array $options = []) : BuildInstance
	{
		...
		$data = Values::of([
			'AssetVersions' => Serialize::map($options['assetVersions'], static function($e) { return $e; }),
			'FunctionVersions' => Serialize::map($options['functionVersions'], static function($e) { return $e; }),
