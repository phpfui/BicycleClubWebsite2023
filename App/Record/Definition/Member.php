...
abstract class Member extends \PHPFUI\ORM\Record
	...
	protected static array $fields = [
		...
		'allowTexting' => ['int(1)', 'int', 1, false, 1, ],
		'cellPhone' => ['varchar(20)', 'string', 20, false, '', ],
		'deceased' => ['int(1)', 'int', 1, false, 0, ],
		'discountCount' => ['int(6)', 'int', 6, false, 0, ],
		'email' => ['varchar(100)', 'string', 100, true, ],
		'emailAnnouncements' => ['tinyint(4)', 'int', 4, false, 0, ],
		'emailNewsletter' => ['int(1)', 'int', 1, false, 1, ],
		...
		'geoLocate' => ['int(1)', 'int', 1, false, 1, ],
		'journal' => ['tinyint(4)', 'int', 4, false, 0, ],
		'lastLogin' => ['timestamp', 'string', 20, false, null, ],
		'lastName' => ['varchar(50)', 'string', 50, true, ],
		'leaderPoints' => ['int(11)', 'int', 11, false, 0, ],
		...
		'newRideEmail' => ['tinyint(4)', 'int', 4, false, 0, ],
		'password' => ['varchar(255)', 'string', 255, true, ],
		'passwordReset' => ['varchar(20)', 'string', 20, true, ],
		'passwordResetExpires' => ['timestamp', 'string', 20, true, ],
		'pendingLeader' => ['int(1)', 'int', 1, false, 0, ],
		'phone' => ['varchar(20)', 'string', 20, false, '', ],
		'profileHeight' => ['int(10)', 'int', 10, false, 0, ],
		'profileWidth' => ['int(10)', 'int', 10, false, 0, ],
		'profileX' => ['int(10)', 'int', 10, false, 0, ],
		'profileY' => ['int(10)', 'int', 10, false, 0, ],
		'rideComments' => ['int(1)', 'int', 1, true, 1, ],
		'rideJournal' => ['tinyint(4)', 'int', 4, false, 0, ],
		'showNoPhone' => ['tinyint(4)', 'int', 4, false, 0, ],
		'showNoStreet' => ['tinyint(4)', 'int', 4, false, 0, ],
		'showNoTown' => ['tinyint(4)', 'int', 4, false, 0, ],
		'showNothing' => ['tinyint(4)', 'int', 4, false, 0, ],
		'verifiedEmail' => ['int(1)', 'int', 1, false, 0, ],
	];
