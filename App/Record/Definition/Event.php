 ...
 *
 * @property ?string $additionalInfo MySQL type mediumtext
 ...
 * @property ?string $information MySQL type mediumtext
...
abstract class Event extends \PHPFUI\ORM\Record
	...
	public function initFieldDefinitions() : static
		...
		if (! \count(static::$fields))
			{
			static::$fields = [
				'additionalInfo' => new \PHPFUI\ORM\FieldDefinition('mediumtext', 'string', 16777215, true, ),
				...
				'information' => new \PHPFUI\ORM\FieldDefinition('mediumtext', 'string', 16777215, true, ),
				...
				'newMemberDiscount' => new \PHPFUI\ORM\FieldDefinition('decimal(6,2)', 'float', 7, false, 0.00, ),
				...
				'price' => new \PHPFUI\ORM\FieldDefinition('decimal(6,2)', 'float', 7, false, 0.00, ),
