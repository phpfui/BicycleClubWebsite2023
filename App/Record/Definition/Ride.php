...
abstract class Ride extends \PHPFUI\ORM\Record
	...
	protected static array $fields = [
		...
		'accident' => ['int(1)', 'int', 1, true, ],
		'averagePace' => ['float', 'float', 0, true, ],
		'commentsDisabled' => ['int(1)', 'int', 1, true, 0, ],
		...
		'numberOfRiders' => ['int(2)', 'int', 2, true, ],
		'paceId' => ['int(11)', 'int', 11, false, 0, ],
		...
		'rideStatus' => ['int(1)', 'int', 1, true, 0, ],
		'signupNotifications' => ['tinyint(4)', 'int', 4, true, 1, ],
		...
		'unaffiliated' => ['int(1)', 'int', 1, true, 0, ],
	];
