...
class PDF_Label extends FPDF
	...
	private int $_Char_Size = 10;         // Character size
	...
	public function _Set_Format(array $format) : void
		{
	...
	public function Add_PDF_Label(string $texte) : void
		{
	...
	public function getLabelStock() : array
		{
	...
	public function Set_Alignment(string $align) : void
		{
	...
	public function Set_Font_Name(string $fontname) : void
		{
		if ('' != $fontname)
			{
	...
	public function Set_Font_Size(int $pt) : void
		{
		if ($pt > 3)
			{
			$this->_Char_Size = $pt;
