...
abstract class RWGPS extends \PHPFUI\ORM\Record
	...
	protected static array $fields = [
		...
		'RWGPSId' => ['int(11)', 'int', 11, false, null, true, ],
		'club' => ['int(1)', 'int', 1, false, 0, false, ],
		'csv' => ['text', 'string', 65535, true, null, false, ],
		'description' => ['varchar(255)', 'string', 255, false, '', false, ],
		'elevation' => ['int(10)', 'int', 10, true, null, false, ],
		'feetPerMile' => ['decimal(5,1)', 'float', 5, false, 0, false, ],
		'lastUpdated' => ['date', 'string', 10, true, null, false, ],
		'latitude' => ['decimal(10,6)', 'float', 10, true, null, false, ],
		'longitude' => ['decimal(10,6)', 'float', 10, true, null, false, ],
		'mileage' => ['decimal(4,1)', 'float', 4, true, null, false, ],
		'query' => ['varchar(255)', 'string', 255, true, null, false, ],
		'startLocationId' => ['int(11)', 'int', 11, true, null, false, ],
		'state' => ['char(2)', 'string', 2, false, '', false, ],
		'status' => ['int(11)', 'int', 11, true, null, false, ],
