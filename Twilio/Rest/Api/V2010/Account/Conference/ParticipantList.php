...
class ParticipantList extends ListResource
	...
	public function create(string $from, string $to, array $options = []) : ParticipantInstance
	{
		...
		$data = Values::of([
			...
			'StatusCallbackEvent' => Serialize::map($options['statusCallbackEvent'], static function($e) { return $e; }),
			'Label' => $options['label'],
			...
			'ConferenceStatusCallbackEvent' => Serialize::map($options['conferenceStatusCallbackEvent'], static function($e) { return $e; }),
			...
			'RecordingStatusCallbackEvent' => Serialize::map($options['recordingStatusCallbackEvent'], static function($e) { return $e; }),
			'ConferenceRecordingStatusCallbackEvent' => Serialize::map($options['conferenceRecordingStatusCallbackEvent'], static function($e) { return $e; }),
