...
- Click on the icon to start. Adjust parameters by right clicking on the icon in the system tray.
- Download and install a client email viewer program, [Thunderbird](https://www.thunderbird.net/) is recommended.
- When the website sends an email, it will go to this server and open an email window with the email
