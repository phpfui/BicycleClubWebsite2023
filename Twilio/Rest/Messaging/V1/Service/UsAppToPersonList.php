...
class UsAppToPersonList extends ListResource
	...
	public function create(string $brandRegistrationSid, string $description, string $messageFlow, array $messageSamples, string $usAppToPersonUsecase, bool $hasEmbeddedLinks, bool $hasEmbeddedPhone, array $options = []) : UsAppToPersonInstance
	{
		...
		$data = Values::of([
			...
			'OptInKeywords' => Serialize::map($options['optInKeywords'], static function($e) { return $e; }),
			'OptOutKeywords' => Serialize::map($options['optOutKeywords'], static function($e) { return $e; }),
			'HelpKeywords' => Serialize::map($options['helpKeywords'], static function($e) { return $e; }),
			'SubscriberOptIn' => Serialize::booleanToString($options['subscriberOptIn']),
			'AgeGated' => Serialize::booleanToString($options['ageGated']),
			'DirectLending' => Serialize::booleanToString($options['directLending']),
		]);
