...
$updater->update();
$updater->copyDirectory(__DIR__ . '/vendor/php-debugbar/php-debugbar/dist', __DIR__ . '/DebugBar/dist');
$updater->copyDirectory(__DIR__ . '/vendor/php-debugbar/php-debugbar/resources', __DIR__ . '/DebugBar/resources');
