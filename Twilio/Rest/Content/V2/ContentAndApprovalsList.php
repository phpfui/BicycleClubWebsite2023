...
class ContentAndApprovalsList extends ListResource
	...
	) : ContentAndApprovalsPage
	{
		...
		$params = Values::of([
			...
			'SortByContentName' => $options['sortByContentName'],
			...
			'Language' => Serialize::map($options['language'], static function($e) { return $e; }),
			'ContentType' => Serialize::map($options['contentType'], static function($e) { return $e; }),
			'ChannelEligibility' => Serialize::map($options['channelEligibility'], static function($e) { return $e; }),
			'PageToken' => $pageToken,
			'Page' => $pageNumber,
			'PageSize' => $pageSize,
		]);
