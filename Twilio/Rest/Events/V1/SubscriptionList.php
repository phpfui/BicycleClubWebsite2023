...
class SubscriptionList extends ListResource
	...
	public function create(string $description, string $sinkSid, array $types, array $options = []) : SubscriptionInstance
	{
		...
		$data = Values::of([
			...
			'SinkSid' => $sinkSid,
			'Types' => Serialize::map($types, static function($e) { return Serialize::jsonObject($e); }),
			'ReceiveEventsFromSubaccounts' => Serialize::booleanToString($options['receiveEventsFromSubaccounts']),
		]);
