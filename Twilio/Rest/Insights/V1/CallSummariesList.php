...
class CallSummariesList extends ListResource
	...
	) : CallSummariesPage
	{
		...
		$params = Values::of([
			...
			'AnsweredByAnnotation' => $options['answeredByAnnotation'],
			'ConnectivityIssueAnnotation' => $options['connectivityIssueAnnotation'],
			'QualityIssueAnnotation' => $options['qualityIssueAnnotation'],
			'SpamAnnotation' => Serialize::booleanToString($options['spamAnnotation']),
			'CallScoreAnnotation' => $options['callScoreAnnotation'],
			'BrandedEnabled' => Serialize::booleanToString($options['brandedEnabled']),
			'VoiceIntegrityEnabled' => Serialize::booleanToString($options['voiceIntegrityEnabled']),
			'BrandedBundleSid' => $options['brandedBundleSid'],
			'VoiceIntegrityBundleSid' => $options['voiceIntegrityBundleSid'],
			'VoiceIntegrityUseCase' => $options['voiceIntegrityUseCase'],
			'BusinessProfileIdentity' => $options['businessProfileIdentity'],
			'BusinessProfileIndustry' => $options['businessProfileIndustry'],
			'BusinessProfileBundleSid' => $options['businessProfileBundleSid'],
			'BusinessProfileType' => $options['businessProfileType'],
			'PageToken' => $pageToken,
			'Page' => $pageNumber,
			'PageSize' => $pageSize,
		]);
